            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item {{ request()->routeIs('home*') ? 'bg-dark' : '' }}">
                    <a class="nav-link" href="{{ route('home') }}">
                        ...
                        <span class="menu-title  {{ request()->routeIs('home*') ? 'text-white' : '' }}" data-i18n="">Dashboard</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('users*') ? 'bg-dark' : '' }}">
                    <a class="nav-link" href="{{ route('users') }}">
                        <i class="la la-user"></i>
                        <span class="menu-title {{ request()->routeIs('users*') ? 'text-white' : '' }}" data-i18n="">Users</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('customers*') ? 'bg-dark' : '' }}">
                    <a class="nav-link" href="{{ route('customers') }}">
                        <i class="la la-group"></i>
                        <span class="menu-title {{ request()->routeIs('customers*') ? 'text-white' : '' }}" data-i18n="">Customers</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('transactions*') ? 'bg-dark' : '' }}">
                    <a class="nav-link" href="{{ route('transactions') }}">
                        <i class="la la-exchange"></i>
                        <span class="menu-title {{ request()->routeIs('transactions*') ? 'text-white' : '' }}" data-i18n="">Transactions</span>
                    </a>
                </li>
                ...
                <li class="nav-item {{ request()->routeIs('guns*') ? 'bg-dark' : '' }}">
                    <a class="nav-link" href="{{ route('guns') }}">
                        ...
                        <span class="menu-title  {{ request()->routeIs('guns*') ? 'text-white' : '' }}" data-i18n="">Guns</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('corridors*') ? 'bg-dark' : '' }}">
                    <a class="nav-link" href="{{ route('corridors') }}">
                        <i class="la la-bullseye"></i>
                        <span class="menu-title  {{ request()->routeIs('corridors*') ? 'text-white' : '' }}" data-i18n="">Corridors</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('calibers*') ? 'bg-dark' : '' }}">
                    <a class="nav-link" href="{{ route('calibers') }}">
                        <i class="la la-send-o"></i>
                        <span class="menu-title {{ request()->routeIs('calibers*') ? 'text-white' : '' }}" data-i18n="">Calibers</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('logs*') ? 'bg-dark' : '' }}">
                    <a class="nav-link" href="{{ route('logs') }}">
                        <i class="la la-credit-card"></i>
                        <span class="menu-title {{ request()->routeIs('logs*') ? 'text-white' : '' }}" data-i18n="">Logs</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('backup*') ? 'bg-dark' : '' }}">
                    <a class="nav-link" href="{{ route('backup') }}">
                        <i class="la la-server"></i>
                        <span class="menu-title {{ request()->routeIs('backup*') ? 'text-white' : '' }}" data-i18n="">Backup</span>
                    </a>
                </li>
                @endif
            </ul>
