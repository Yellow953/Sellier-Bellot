...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('customers')->group(function () {
        ...
        Route::get('/edit/{user}', [CustomerController::class, 'edit'])->name('customers.edit');
        Route::post('/update/{user}', [CustomerController::class, 'update'])->name('customers.update');
        Route::get('/delete/{user}', [CustomerController::class, 'destroy'])->name('customers.destroy');
    });
    ...
    Route::prefix('guns')->group(function () {
        ...
        Route::get('/edit/{user}', [GunController::class, 'edit'])->name('guns.edit');
        Route::post('/update/{user}', [GunController::class, 'update'])->name('guns.update');
        Route::get('/delete/{user}', [GunController::class, 'destroy'])->name('guns.destroy');
    });
    ...
    Route::prefix('calibers')->group(function () {
        ...
        Route::get('/edit/{user}', [CaliberController::class, 'edit'])->name('calibers.edit');
        Route::post('/update/{user}', [CaliberController::class, 'update'])->name('calibers.update');
        Route::get('/delete/{user}', [CaliberController::class, 'destroy'])->name('calibers.destroy');
    });
    ...
    Route::prefix('corridors')->group(function () {
        ...
        Route::get('/edit/{user}', [GunController::class, 'edit'])->name('corridors.edit');
        Route::post('/update/{user}', [GunController::class, 'update'])->name('corridors.update');
        Route::get('/delete/{user}', [GunController::class, 'destroy'])->name('corridors.destroy');
    });
    ...
    Route::prefix('transactions')->group(function () {
        ...
        Route::get('/edit/{user}', [TransactionController::class, 'edit'])->name('transactions.edit');
        Route::post('/update/{user}', [TransactionController::class, 'update'])->name('transactions.update');
        Route::get('/delete/{user}', [TransactionController::class, 'destroy'])->name('transactions.destroy');
    });
